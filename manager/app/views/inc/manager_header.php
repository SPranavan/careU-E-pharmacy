...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo URLROOT; ?>/public/css/Manager/initiated_orders.css">
    <link rel="stylesheet" type="text/css" href="<?php echo URLROOT; ?>/public/css/Manager/cancelled_orders.css">
    <link rel="stylesheet" type="text/css" href="<?php echo URLROOT; ?>/public/css/Manager/pass_order.css">
    <link rel="stylesheet" type="text/css" href="<?php echo URLROOT; ?>/public/css/Manager/refund_order.css">
    <link rel="stylesheet" type="text/css" href="<?php echo URLROOT; ?>/public/css/Manager/feedback.css">
    <link rel="stylesheet" type="text/css" href="<?php echo URLROOT; ?>/public/css/Manager/feedback_details.css">
    <link rel="stylesheet" type="text/css" href="<?php echo URLROOT; ?>/public/css/Manager/report.css">
    ...
    <header>
        ...
        <div class="bottomNav">
            ...
            <div class="bottomNav-left">
                ...
                <div class="dropdown1">
                <button class="dropbtn1"><a href="#" style="text-decoration: none;color: inherit;">Report</a></button>
                ...
                <div class="dropdown2">
                <button class="dropbtn2"><a href="#" style="text-decoration: none;color: inherit;">Feedback</a></button>
                ...
                <div class="dropdown-content3">
                    <a href="<?php echo URLROOT; ?>/pages/initiated_orders">Initiated Orders</a>
                    <a href="<?php echo URLROOT; ?>/pages/cancelled_orders">Cancelled Orders</a>
                </div>
                </div>
