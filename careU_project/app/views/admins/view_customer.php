<?php require APPROOT . '/views/inc/admin_header.php'; ?>
    ...
    <div class="box2">
        ...
        <a href="<?php echo URLROOT; ?>/admins/view_customer"><span class="actor1">Customer</span></a><br><br>
    </div>
          ...
          <h3 class="topic1-view">Details | Customer</h3>
            ...
            <table>
                    ...
                    <tr class="dataset1">
                        ...
                        <td></td>
                        <td></td>
                        <td class="vm"><a href=""><button class="viewMore"><img src="<?php echo URLROOT;?>/public/img/header/eye.png" alt="view more" style="width:30px;height:20px;"></button></a></td>
                    </tr>
