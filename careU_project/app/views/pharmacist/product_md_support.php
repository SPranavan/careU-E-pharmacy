...
<head>
<link rel="stylesheet" type="text/css" href="<?php echo URLROOT; ?>/public/css/pharmacists/product_md_support.css">
</head>
    ...
    <div class="side_element">
        <div class="side_options">
            ...
            <br>
            <a href="product_md_healthdevice">Health Devices</a>
            <br>
            <a class="heart">Support</a>
    ...
    <?php 
        ...
        for ($i=0; $i < $countdata; $i++) { 
            ...
            <div class="box1">
                ...
                <p>Quantity :<span class="data"> '.$data[$i]-> quantity_measurement.'</span> </p></div> ';
        };
