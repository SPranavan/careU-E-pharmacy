...
<form method="POST">
    ...
    <div class="change">
        ...
        <a href="change_email"><b>Change Email</b></a><br>
...
<form method="POST">
    ...
    <label class="label-edit" for="name">Email</label><br>
    <input type="text" class="input-edit" id="name" name="name"><br>
    <label class="label-edit" style="top: 100px;" for="number">Current Password</label><br>
    <input type="text" class="input-edit" style="margin: 80px 0px;" id="number" name="number"><br>
