...
<head>
    <link rel="stylesheet" href="personal_care.css">
...
<?php require_once('./header.php');
    ...
    <div class="side_element">
        ...
        <div class="side_options">
            <a class="heart" href="home.php">Nourishments</a><br>
            <a href="accessories.php">Accessories</a><br>
            <a href="infection.php">Skin care</a><br>
            <a href="gastro.php">Women personal care</a><br>
            <a href="muscle.php">Oral care</a>
    ...
    <div class="tables">
        <table class="table_cont">
            ...
            <?php 
                $sql = "SELECT * FROM medicine WHERE medicine_type1='medicine' AND medicine_type2 ='heart' ";
